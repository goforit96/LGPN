...
from .metrics import bbox_iou #,bbox_inner_iou,bbox_mpdiou,bbox_inner_mpdiou
...
def wasserstein_loss(param, param1):
    pass


class BboxLoss(nn.Module):  #边界框的回归损失
    ...
    def __init__(self, reg_max, use_dfl=False):
        ...
        self.nwd_loss = False   #新加的NDW损失函数
        self.iou_ratio = 0.5    #新加的NDW损失函数阀值
